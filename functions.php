...
function my_script_init()
{
	...
	wp_enqueue_style( 'google-fonts', 'link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@400;500;700&family=Sorts+Mill+Goudy&display=swap" rel="stylesheet"', false );
